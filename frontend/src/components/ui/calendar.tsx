  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 flex items-center justify-center rounded-md border border-slate-200 dark:border-slate-800'
        ),
        ...
        day: cn(
          'h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md flex items-center justify-center'
        ),
